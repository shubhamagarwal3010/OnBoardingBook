...
public class AboutScreenActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.thoughtworks.ar.onboarding.R.layout.about_screen);
        ...
        mAboutWebText = (WebView) findViewById(com.thoughtworks.ar.onboarding.R.id.about_html_text);
        ...
        mStartButton = (Button) findViewById(com.thoughtworks.ar.onboarding.R.id.button_start);
        mStartButton.setOnClickListener(this);

        mAboutTextTitle = (TextView) findViewById(com.thoughtworks.ar.onboarding.R.id.about_text_title);
    ...
    private void startARActivity() {
        Intent i = new Intent(AboutScreenActivity.this, OnBoardingActivity.class);
        startActivity(i);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.thoughtworks.ar.onboarding.R.id.button_start:
                startARActivity();
                break;
        }
    }
